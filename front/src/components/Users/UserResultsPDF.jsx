  ...
  return (
    <Document>
        <Page size={"A4"}>   
            ...
            <View style={{width: "100%", display: "flex", alignItems: "center", borderLeft: "8px solid #2b2c91", paddingLeft: "5px"}}>
                <View style={{width: "70%"}}>
            ...
            <View style={{ fontSize: "14px", width: "100%", display: "flex", alignItems: "center"}}>
              <View style={{width: "70%"}}>
                <Text style={{fontSize: "20px"}}>Miedos en este momento que te impiden avanzar</Text>
                <Text>Todos tenemos miedos, a veces no conscientes, que provocan un estancamiento en nuestro desarrollo personal.</Text>
                <Text>Poder hacerlos conscientes y trabajarlos es lo que nos empieza a mover del lugar en el que nos encontramos para llevarnos a un lugar de mayor plenitud.</Text>
                <View>
